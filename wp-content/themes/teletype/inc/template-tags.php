 ...
 * to do ? if ( is_active_widget( '', '', 'teletype_icon_widget' ) )
 */
function teletype_sidebar_params($params) {
	...
	/*
    	if ( $my_widget_num[$sidebar_id] == 4 || $my_widget_num[$sidebar_id] == 7 || $my_widget_num[$sidebar_id] == 10 ) {
        		$params[0]['before_widget'] = str_replace( '<div', '</div><div class="row"><div', $params[0]['before_widget'] );
	}
	*/
    }
    return $params;
...
add_filter('dynamic_sidebar_params','teletype_sidebar_params');
