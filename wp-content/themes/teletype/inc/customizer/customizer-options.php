...
function teletype_customizer_library_options() {
	...
	$sections[] = array(
		'id' => $section,
		'title' => esc_html__( 'Home Sections Order', 'teletype' ),
		'priority' => '70',
		'description' => esc_html__( 'The visibility and order of sections Front page (assign the Front Page template).', 'teletype' )
	);
	...
	$options['homesorter'] = array(
		'id' 	=> 'homesorter',
		//'label'	=> esc_html__( 'Home Sections', 'teletype' ),
		'section' 	=> $section,
		'type'	=> 'ckecksorter',
		'choices'	=> $choices,
	...
	$options['headline-text'] = array(
		'id' => 'headline-text',
		'label'   => esc_html__( 'Home Headline Content', 'teletype' ),
		'section' => $section,
		'type'    => 'textarea',
		'default' => '',
	);
	...
	$options['blog-headline-content'] = array(
		...
		'label'   => esc_html__( 'Blog Headline Content', 'teletype' ),
		'section' => $section,
		'type'    => 'textarea',
		'default' => '',
	);
	...
	$panels[] = array(
		'id' => $panel,
		'title' => esc_html__( 'Home Sections', 'teletype' ),
		'description' => esc_html__( 'As the Front page should be selected static page and assigned it the Front Page template. ', 'teletype' ),
		'priority' => '70'
	);
